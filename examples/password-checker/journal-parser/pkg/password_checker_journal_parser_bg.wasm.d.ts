...
export function json_obj_from_journal_bytes(a: number, b: number, c: number): void;
...
export function sys_verify_integrity(a: number): void;
...
export function sys_verify(a: number, b: number, c: number): void;
